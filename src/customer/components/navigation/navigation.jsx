...
export const Navigation = () => {
  ...
  const handleLogout = () => {
    handleMenuClose();
    setIsLoggedIn(false); // Example update
  };
    ...
    <div className="bg-[#F1EDE1] w-full mb-10">
      ...
      <Dialog open={open} onClose={() => setOpen(false)} className="relative z-40 lg:hidden">
        ...
        <div className="fixed inset-0 z-40 flex">
          <DialogPanel
            transition
            className="relative flex w-full max-w-xs transform flex-col overflow-y-auto bg-[#FFF5CD] pb-12 shadow-xl transition duration-300 ease-in-out data-closed:-translate-x-full"
          >
              ...
              <div className="ml-auto flex items-center">
                  ...
                  {isLoggedIn ? (
                    <>
                      <IconButton onClick={handleMenuOpen} size="small" sx={{ ml: 2 }}>
                        <Avatar sx={{ bgcolor: "white", color: 'black', width: 36, height: 36 }}>K</Avatar>
                      </IconButton>
                      ...
                      >
                        ...
                        <MenuItem onClick={() => { handleMenuClose(); window.location.href = "/account/order"; }}>My Orders</MenuItem>
                ...
                <div className="flex lg:ml-6">
                  <a href="#" className="p-2 text-white hover:text-gray-500">
                    ...
                    <MagnifyingGlassIcon aria-hidden="true" className="size-9 bg-[#D8A353] rounded-full p-1" />
                  </a>
                </div>
                ...
                <a href="/cart" className="group -m-2 flex items-center p-2">
                    <ShoppingBagIcon aria-hidden="true" className="size-9 shrink-0 p-1 bg-[#D8A353] text-white rounded-full group-hover:text-gray-500"
                    />
